...
public  class zMainActivity extends Activity implements AMapLocationListener {
                    ...
                    public void run() {
                        if(accid!=-1) {
                            ...
                            try {
                                ...
                                zConnectDatabase.uploadLocation(currentPoint, accid);
...
class HomeAdapter extends RecyclerView.Adapter<HomeAdapter.ItemViewHolder>{
    ...
    public void onBindViewHolder(@NonNull ItemViewHolder holder, int position) {
        holder.gender.setText("Gender: "+zMainActivity.Demodata.get(position).getGender());
        holder.distance.setText("Distance: "+Double.toString(zMainActivity.Demodata.get(position).getDistance())+" km");
        holder.name.setText("Name: "+zMainActivity.Demodata.get(position).getUserName());
        holder.button.setOnClickListener(a->{
            Intent intent = new Intent(mContext,person_info.class);
            Bundle bundle=new Bundle();
            bundle.putInt("accid",zMainActivity.Demodata.get(position).accid);
    ...
    public int getItemCount() {
        return zMainActivity.Demodata.size();
    }
